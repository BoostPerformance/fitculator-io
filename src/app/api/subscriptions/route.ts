...
export async function POST(req: NextRequest) {
  try {
    ...
    const result = await prisma.$transaction(async (tx) => {
      ...
      const exercise_preferencesInfo = await tx.exercisepreferences.create({
        data: {
          id: nanoid(),
          user_id: userInfo.id,
          ...
          exercise_performance_level:
            body.exercise_preferences.exercise_performance_level,
          ...
          ldl_cholesterol: body.exercise_preferences.ldl_cholesterol || null,
          total_cholesterol:
            body.exercise_preferences.total_cholesterol || null,
        },
      });
