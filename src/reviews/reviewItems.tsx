...
const reviewItems: ReviewItems = [
  ...
  },
  {
    id: 4,
    title:
      '질문 봇 기능이 생각보다 좋아요. 코치님들이 한 번 더 봐주시니까 믿을만한 정보',
    content:
  ...
  {
    id: 5,
    title: '활동량을 보면서 채우고자 하는 욕심이 운동의 동기부여가 되더라구요',
    content:
  ...
  {
    id: 6,
    title: '운동 루틴을 만들어 갈 수 있어서 큰 도움이 됐습니다.',
    content:
      '핏큘레이터 덕분에 운동습관을 다시 잡아볼 수 있었어요! 특히, 혼자였다면 금방 포기했을텐데 내가 채워야하는 활동량을 보면서 채우고자 하는 욕심이 운동의 동기부여가 되더라구요 :)',
    author: '익명의 후기 (만족도 설문 응답 결과)',
  },
  {
  ...
  },
   {
    id: 8,
    title:
      '개인 맞춤형으로 웨이트 루틴을 짜주는게 개인적으로 너무 만족스러웠습니다',
    content:
  ...
  },
  {
    id: 9,
    title:
      'Fitculator 프로젝트를 통해 적절한 운동량을 확인할 수 있어서 좋았습니다',
    content:
  ...
  },
   {
    id: 10,
    title:
      '맨날 홈트해야지 생각만 했었는데, 핏큘레이터 덕분에 처음 해봤어요!',
    content:
